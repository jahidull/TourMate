...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
      ...
      //  mMap.moveCamera( CameraUpdateFactory.newLatLngZoom(you , 6.6f) );
        ...
        for(int i=0; i<DonorList.donorInfo.size(); i++){
          ...
          //  Toast.makeText(this, donar.toString(), Toast.LENGTH_SHORT).show();
            ...
            String details = donor.contuctNumber+" "+donor.gender;
            mMap.addMarker(new MarkerOptions().position(donar).title(donorName).snippet(details).icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_GREEN)));
    ...
    private void initMap() {
        ...
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.input);
