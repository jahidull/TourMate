...
public class DonorAll {
    ...
    public DonorAll(String name, String contuctNumber, String bloodGroup, String city, String lat, String lng, String gender, String last, String age, String weight) {
        this.name = name;
